...
const CONFIG = {
  github: {
    username: 'kisalnelaka', // Your GitHub org/user name. (This is the only required config)
  },
  /**
  ...
  resume: {
    fileUrl:
      'https://kisalnelaka.github.io/resume/', // Empty fileUrl will hide the `Download Resume` button.
  },
  skills: [
    'PHP',
    'Python',
